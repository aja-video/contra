...
require (
	...
	github.com/google/goexpect v0.0.0-20171114050113-756071476d41
	github.com/google/goterm v0.0.0-20171114051514-a4092ec68257 // indirect
	...
	gopkg.in/src-d/go-git.v4 v4.2.0
